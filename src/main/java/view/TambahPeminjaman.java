...
public class TambahPeminjaman extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TambahPeminjaman.class.getName());
    private Peminjaman framePeminjaman;
    
public TambahPeminjaman(Peminjaman frameInduk) {
    initComponents();
    this.framePeminjaman = frameInduk; // Simpan referensi frame utama
    ...
    // Prodi tidak ada di tabel utama, jadi kita bisa abaikan atau simpan di tempat lain
    // String prodi = jTextField3.getText(); 
    String tglJatuhTempo = jTextField4.getText();
    String buku = jComboBox2.getSelectedItem().toString();
    String nomorBuku = jComboBox1.getSelectedItem().toString();

    // 2. Siapkan data dalam bentuk array Object sesuai urutan kolom di tabel Peminjaman
    // Urutan kolom: Nama MHS, NRP, Buku, Nomer Eksemplar, Status, Tgl Pinjam, Tgl Jatuh Tempo, Aksi
    ...
    if (framePeminjaman != null) {
        framePeminjaman.tambahDataPeminjam(dataBaru);
