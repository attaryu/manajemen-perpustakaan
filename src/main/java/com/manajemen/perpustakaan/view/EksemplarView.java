...
public class EksemplarView extends javax.swing.JFrame {
    ...
    public EksemplarView() {
        ...
        this.tblDaftarEksemplar.setRowHeight(30);
    }

    private void setupTableColumns() {
        javax.swing.table.TableColumn aksiColumn = tblDaftarEksemplar.getColumnModel()
                .getColumn(2);
        ...
        if (this.actionCallback != null) {
            actions.get(0).setCallback(this.actionCallback::onDelete);

            IdGetter idGetter = (row) -> {
                Object idValue = tblDaftarEksemplar.getValueAt(row, 0);
    ...
    private void initComponents() {
        ...
        jScrollPane5.getAccessibleContext().setAccessibleParent(jScrollPane5);
